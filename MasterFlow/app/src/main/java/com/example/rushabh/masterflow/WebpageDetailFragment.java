package com.example.rushabh.masterflow;
...
import com.example.rushabh.masterflow.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ...
            ((WebView) rootView.findViewById(R.id.details)).loadUrl(mItem.url);
        }
